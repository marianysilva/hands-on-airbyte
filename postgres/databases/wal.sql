...
ALTER SYSTEM SET checkpoint_timeout = 18000;
...
SHOW checkpoint_timeout; -- 5h
SHOW wal_buffers; -- 64MB
SHOW wal_receiver_timeout; -- 5min

SELECT pg_create_logical_replication_slot('airbyte_slot', 'pgoutput');

ALTER TABLE orderdb.customer REPLICA IDENTITY DEFAULT;
ALTER TABLE orderdb.employee REPLICA IDENTITY DEFAULT;
ALTER TABLE orderdb.order REPLICA IDENTITY DEFAULT;
ALTER TABLE orderdb.order_line REPLICA IDENTITY DEFAULT;
